...
<body>
	<div class="cover">
		...
		<div class="bdy">
			...
			<marquee class="disclaimer" direction="left" scrollamount="7">Your profile is ready !! Add a profile picture to make your profile more recognizable !!!!</marquee>
			<div class="box">
				<form id="imgForm" action="../actionjsp/addImgAction.jsp"
